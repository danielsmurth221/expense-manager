...
class Pager extends React.Component {
    constructor(props) {
        ...
        // call the calculate() method to get the initial details about the pagination
                ...
                <div style={{ width: 720, margin: 0 }}>
                    <div className="container">
                        <div className="pagination p1">
                            <ul>
                                {this.state.currentPage != 1 ? <a href="#" onClick={this.handleClick.bind(this, this.state.currentPage - 1)}><li>Prev</li></a> : <span> </span>}
                                {pages}
                                {this.state.currentPage != this.state.totalPages ?
                                <a href="#" onClick={this.handleClick.bind(this, this.state.currentPage + 1)}><li>Next</li></a> : <span> </span>}
                            </ul>
                        </div>
                    </div>
                </div>
